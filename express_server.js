...
app.post("/urls", (req, res) => {
  ...
  urlDatabase[newShortUrl] = { loggedUserCookie, longURL } ; //urlDatabase is updated by assigning the value of req.body.longURL (the long url path)to the newShortUrl key
